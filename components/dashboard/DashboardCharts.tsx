...
export default function DashboardCharts() {
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
      ...
      <div className="glass-card p-6 border border-slate-100 bg-white relative overflow-hidden animate-fade-in">
        {/* Glow sutil */}
      ...
      <div className="glass-card p-6 border border-slate-100 bg-white relative overflow-hidden animate-fade-in">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-8 relative z-10 py-2">
          ...
          <div className="space-y-3.5 flex-1 w-full">
            <div className="flex items-center gap-3 px-3 py-2 bg-slate-50 border border-slate-100 rounded-lg">
